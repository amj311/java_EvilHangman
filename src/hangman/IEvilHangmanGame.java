...
public interface IEvilHangmanGame {
	 ...
	 */
	void startGame(File dictionary, int wordLength) throws IOException, EmptyDictionaryException, hangman.EmptyDictionaryException;
	 ...
	 */
	Set<String> makeGuess(char guess) throws GuessAlreadyMadeException, hangman.GuessAlreadyMadeException;
